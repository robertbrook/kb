CREATE TABLE "records" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "notes" text DEFAULT NULL NULL, "web_page" varchar(255) DEFAULT NULL NULL, "created_at" datetime DEFAULT NULL NULL, "updated_at" datetime DEFAULT NULL NULL, "name" varchar(255) DEFAULT NULL NULL, "check_by_date" date DEFAULT NULL NULL, "use_check_by_date" boolean DEFAULT NULL NULL, "summary" varchar(255) DEFAULT NULL NULL, "other_notes" text DEFAULT NULL NULL);
